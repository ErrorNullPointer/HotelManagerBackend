...
public class CancelReservation extends javax.swing.JFrame {
    ...
    private ArrayList<Reserve> resList = null;
    private ArrayList<Room> roomList = null;
    /**
     * Creates new form CancelReservation
     */
    public CancelReservation(UserInformation aUser) {
        initComponents();  
        user = aUser;
    ...
    private void initComponents() {
        ...
        ListofRes = new javax.swing.JList();
        ...
        ListofRes.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(ListofRes);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ReserveID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        try{
            ...
            {
                JOptionPane.showMessageDialog(null, "Invalid Reservation number.");
            }
    ...
    public void update()
    {
        if(resList.size()>=0)
        {
            ListofRes.setModel(new ModelAdapter(resList));
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CancelReservation(user).setVisible(true);
            }
        });
    }
